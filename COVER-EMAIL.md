...
**Two numbers to double-check if you edit:** the prototype currently reports **124 accounts / 771 sites**. If you regenerate the EPA pull before sending, those figures move — the README and the in-app panel both read from the same data, but the email body is hardcoded.
